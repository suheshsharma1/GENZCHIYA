            ...
            {cashierTab === 'qr' && (
              <div className="space-y-6">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200/80 dark:border-brand-dark-border pb-4">
                  ...
                  <form onSubmit={handleSaveBaseUrl} className="flex gap-2 max-w-md w-full">
                    <input
                      type="url"
                      value={qrBaseUrl}
                    ...
                    <button
                      type="submit"
                      className="bg-brand-emerald hover:bg-brand-sage text-white text-xs font-bold px-4 py-2 rounded-xl shadow transition-colors cursor-pointer"
                    >
                      Save URL
                    </button>
                  </form>
